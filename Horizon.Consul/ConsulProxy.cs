...
{
    public class ConsulProxy: IRegistryHost
    {
        private const string VERSION_PREFIX = "version-";

        private readonly ConsulHostConfiguration _configuration;
        private readonly ConsulClient _consul;

        public ConsulProxy(ConsulHostConfiguration configuration = null)
        {
        ...
        public async Task<IList<ServiceInformation>> FindServiceInstancesAsync(Predicate<KeyValuePair<string, string[]>> nameTagsPredicate, Predicate<ServiceInformation> registryInformationPredicate)
        {
